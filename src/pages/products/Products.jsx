...
function DataTables() {
    ...
    const checkPrivileges = () => {
        ...
        setAllowAdding(privilege.includes('PRODUCTS_ADD'));
        setAllowUpdating(privilege.includes('PRODUCTS_EDIT'));
        setAllowDeleting(privilege.includes('PRODUCTS_DELETE'));
    }
    ...
    const columns = [
        {Header: "Malın Kodu", accessor: "itemCode", width: "20%"},
        {Header: "Malın adı", accessor: "itemName", width: "25%"},
        {Header: "Malın növü", accessor: "itemTypeId", width: ""},
    ...
    const applyFilter = (filterValues) => {
        ...
        fetchProductList({
            ...
            itemTypeId:
                filterValues.itemTypeId === null ? undefined : filterValues.itemTypeId,
        });
    };
    ...
    const handleExportAsXlsx = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Mallar");
