...
import SingleTable from "pages/recievingProducts/SingleTable";

function NewRecievingProduct() {
                    ...
                    >
                      ...
                      <MDBox display="flex" gap={2}>
                        <MDButton
                          variant="gradient"
                          color="dark"
                          onClick={() => navigate("/modules/recievingProducts")}
                          sx={{
                            color: "darkBlue.main",
                            background:
...
export default NewRecievingProduct;
