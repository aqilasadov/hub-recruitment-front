...
function DataTables() {
    ...
    const checkPrivileges = () => {
        ...
        setAllowAdding(privilege.includes('STOCK_RECEIPT_ADD'));
        setAllowUpdating(privilege.includes('STOCK_RECEIPT_EDIT'));
        setAllowDeleting(privilege.includes('STOCK_RECEIPT_DELETE'));
    }
                                    ...
                                    </MDButton>
                                    {
                                        allowAdding && (
                                            <MDButton
                                                ...
                                                onClick={() => navigate("/modules/recievingProducts/new")}
                                            >
