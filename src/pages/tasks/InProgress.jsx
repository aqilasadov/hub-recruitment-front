                    ...
                    <MDBox display="flex" flexDirection="column" gap={1}>
                        <Autocomplete
                            ...
                            value={employeeList.find(
                                (emp) => emp.empId === filters.executiveEmpId || null
                            )}
                            onChange={(event, newValue) => {
                                setFilters((prev) => ({
                                    ...prev,
                                    executiveEmpId: newValue ? newValue.empId : null,
                                }));
                            }}
                            renderInput={(params) => (
                                <FormField
            ...
            <MDBox pt={6} pb={3}>
                <MDBox mb={3} position="relative">
                    ...
                    <InProgressFilter
                        ...
                        fetchCompletedTaskList={fetchCompletedTaskList}
                    />
                    <DeleteConfirmation
