                                ...
                                <Form>
                                    <MDBox display="flex" justifyContent="space-between" alignItems="start" mb={4}>
                                        ...
                                        <MDBox display="flex" gap={2}>
                                            <MDButton variant="gradient" color="dark" onClick={() => navigate("/modules/contracts")} sx={{
                                                color: "darkBlue.main",
                                    ...
                                    <MDBox>
                                        ...
                                        <MDBox display="flex" flexDirection="column" gap={5} mb={4} px={2}>
                                            <MDBox display="flex" gap={5} >
                                                <MDInput variant="standard" type="text"  placeholder="Qeydiyyat nömrəsi*" required sx={{ width: "100%" }} />
                                                <MDInput variant="standard" type="text" placeholder="Satınalma predmeti*" required sx={{ width: "100%" }} />
                                            </MDBox>
                                            <MDBox display="flex" gap={5}>
                                                <Autocomplete
                                    ...
                                    <MDBox >
                                        ...
                                        <MDBox display="flex" flexDirection="column" gap={5} px={2} mb={4}>
                                            <MDBox display="flex" gap={5} sx={{ width: "100%" }}>
                                                <MDInput variant="standard" type="date" placeholder="Müqavilənin başlama tarixi" sx={{
                                                    width: "100%"
                                                }}
                                                />
                                                <MDInput variant="standard" type="date" placeholder="Müqavilənin bitmə tarixi" sx={{
                                                    width: "100%"
                                                }}
                                                />
                                            </MDBox>
                                            <MDBox display="flex" gap={5}>
                                                ...
                                                <Autocomplete
                                                    ...
                                                    sx={{ width: "100%" }}
                                                />
                                                <MDInput variant="standard" type="text" placeholder="Yekun" sx={{ width: "100%" }} />
                                            </MDBox>
                                        </MDBox>
                                    </MDBox>
                                    <MDBox>
                                        ...
                                        <MDBox display="flex" flexDirection="column" gap={5} px={2} mb={4}>
                                            ...
                                            <MDBox display="flex" gap={5}>
                                                <MDInput variant="standard" type="text" placeholder="Qeyd" sx={{
                                                    width: "100%"
                                                }}
                                                />

                                                <MDInput variant="standard" type="text" placeholder="Açıqlama" sx={{ width: "100%" }} />
                                            </MDBox>
                                            <MDBox sx={{
